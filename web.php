...
Route::get('/dashboard/flyer', function () {
    return view('pages.flyer');
});

Route::get('/events/draw', function () {
    return redirect('https://www.facebook.com/yours.meals/posts/pfbid0ayRSdecwvNA56YVNo4e6C8HgPHQJ9tfkQee56VmQ55eCfUAyJ8zpjZzvwcgRc86Tl');
});
